...
class monit_tools_widget extends widget
{
    ...
    function display_test() {
		echo ('
			...
			');
		echo ('<td class="rowOdd"><div class="tooltip"'.($this->monitored_tools[0] > 0?' style="color: #c75a00;"':'').'"><sup>'.$this->monitored_tools[0].'</sup><span style="top:-50px;  pointer-events: none;" class="tooltiptext">Running</span>');
